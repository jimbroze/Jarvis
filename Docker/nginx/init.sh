envsubst '${DOMAIN_NAME}' < /etc/nginx/config/ddclient.conf > /etc/ddclient.conf
...
envsubst '${DOMAIN} ${SUBDOMAIN} ${DOMAIN_NAME}' < /etc/nginx/config/templates/app.conf > /etc/nginx/conf.d/app.conf
envsubst '${DOMAIN} ${SUBDOMAIN} ${DOMAIN_NAME}' < /etc/nginx/config/templates/ssl.conf > /etc/nginx/snippets/ssl.conf
